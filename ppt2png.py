...
class Ppt2Png(object):
    ...
    def __init__(self,ppt_filename,img_dir,txt_dir):
        GOLBAL.__init__()
        Remover.dir_under(img_dir)
        Remover.dir_under(txt_dir)
...
if __name__ == '__main__':
    ppt_filename=r'F:\PySpace\split_ppt\ppt\class1.pptx'
    img_dir = r'F:\PySpace\split_ppt\img'
    txt_dir=r'F:\PySpace\split_ppt\txt'
